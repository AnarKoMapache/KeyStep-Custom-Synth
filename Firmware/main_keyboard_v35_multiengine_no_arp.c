...
/*
 * KeyStep Keyboard V35 - MultiEngine Mono Synth Real Matrix PE/PD
 *
 ...
 *
 * Audio de prueba:
 *   DAC1 / PA4 / Pitch CV = mono MultiEngine: MicroFreak-ish, Yamaha FM, Moog lead, Acid bass, Digital bell.
