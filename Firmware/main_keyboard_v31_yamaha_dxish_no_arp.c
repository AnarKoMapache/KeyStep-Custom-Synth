...
/*
 * KeyStep Keyboard V31 - Yamaha / Reface DX-ish FM Mono Keys Real Matrix PE/PD
 *
 ...
 *
 * Audio de prueba:
 *   DAC1 / PA4 / Pitch CV = FM mono tipo Yamaha/Reface DX-ish, sin arpegiador.
...
/* Envolventes 0..4096. V31: FM digital tipo Yamaha/Reface DX, sin arpegiador. */
#define MAX_POLY_VOICES       1U

/* V31: más Yamaha/Reface DX-ish: ataque brillante, cuerpo limpio y cola digital. */
#define AMP_ATTACK_STEP       900U
#define AMP_DECAY_STEP        22U
#define AMP_SUSTAIN_LEVEL     1850U
#define AMP_RELEASE_STEP      26U

/* Reutilizamos filter_env como FM-index envelope: golpe brillante que luego se suaviza. */
#define FILTER_ATTACK_STEP    1300U
#define FILTER_DECAY_STEP     42U
#define FILTER_SUSTAIN_LEVEL  420U
#define FILTER_RELEASE_STEP   70U

#define PORTAMENTO_SHIFT      6U    /* glide casi instantaneo, mas tipo teclado FM */
...
static void synth_trigger_key(uint8_t key_index, uint8_t retrigger)
{
  ...
  if (retrigger)
  {
    /* Ataque tipo DX: nota nueva limpia, sin barrido largo. */
...
static int32_t Poly_RenderVoice(PolyVoice *v)
{
  ...
  /* FM estilo Yamaha/Reface DX-ish.
